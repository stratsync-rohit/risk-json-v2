...
export interface RiskBlock { type: BlockType; title?: string; text?: string; status?: string; bold?: boolean; subtle?: boolean; columns?: number | Array<{key:string;label:string}>; items?: GenericItem[] | string[]; rows?: Record<string, unknown>[]; uiId?: string; [key:string]: unknown }
